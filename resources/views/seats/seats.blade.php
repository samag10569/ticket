...
<section class="our-speaker-area section-padding-100">
    <div class="container">
        ...
        <div class="more-speaker-btn text-center mt-20  fadeInUp " data-wow-delay="300ms">
            <a href="{{route('section_select')}}" style="color: black;"><button class="btn  mbuy px-3 py-2" style="font-size: 22px;" href="#mshows">
                    خرید بلیط</button></a>
        </div>
        <!-- ==== End of Buy Area =====-->
        ...
        <!-- === final ==== -->
        <div class="more-speaker-btn text-center mt-20  fadeInUp " data-wow-delay="300ms">
            <a href="{{route('final_ticket')}}" style="color: black;"><button class="btn  mbuy px-3 py-2" style="font-size: 22px;" href="#mshows">
