    ...
    <div class="container">
        <div class="d-flex justify-content-center h-100" style="padding-top:80px;">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('profile')}}" method="get" class="bgform">
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" style="border-radius: 15%; width:40px;"><i class="fa fa-envelope "></i></span>
                                {{-- <i class="fas fa-user"></i> --}}
                            </div>
                            <input id="email" type="email" placeholder="آدرس پست الکترونیک" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" class="bginput">
                            @error('email')
                        ...
                        <div class="form-group float-left" >
                          {{-- <div class="btn confer-btn  mt-lg-0 ml-3 ml-lg-5" ><input type="submit" value="ورود" style="color: black;  " class="hsubmit"> </div> --}}
                            {{-- <a href="{{route('profile')}}" class="btn confer-btn  mt-lg-0 ml-3 ml-lg-5"><h6 class="pt-2">ورود</h6> <i class="zmdi zmdi-long-arrow-right"></i></a> --}}
